...
!["Data Cowboy" by Allison Horst.](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/data_cowboy.png)
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_1.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_1.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_2.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_2.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_3.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_3.PNG"
```
...
![](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/tidydata_4.jpg)
...
!["The standard structure of tidy means that 'tidy datasets are all alike ... but every messy dataset is messy in its own way." - Hadley Wickham. Tidy data sets saying "Our columns are variables and our rows are observations", messy data sets saying "my columns are values and my rows are variables; I have variables in columns and in rows; I have multiple variables in a single columns; I don't even know what my deal is". Illustrations from the [Openscapes](https://www.openscapes.org/) blog [*Tidy Data for reproducibility, efficiency, and collaboration*](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by Julia Lowndes and Allison Horst](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/tidydata_2.jpg)
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_4-pew_wide.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_4-pew_wide.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_6-pew_tidy.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_6-pew_tidy.PNG"
```
...
![Tidy data showing how cells relate to one another in a wide and long format. Taken from Garrick Aden-Buie's ['tidyexplain' repository](https://github.com/gadenbuie/tidyexplain#tidy-data)](https://github.com/gadenbuie/tidyexplain/raw/master/images/static/png/original-dfs-tidy.png)

![Animation showing how cells relate to one another in a wide and long format. Taken from Garrick Aden-Buie's ['tidyexplain' repository](https://github.com/gadenbuie/tidyexplain#tidy-data)](https://github.com/gadenbuie/tidyexplain/raw/master/images/tidyr-spread-gather.gif)
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_9-tb_messy.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_9-tb_messy.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_10-tb_tidy_process.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_10-tb_tidy_process.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_11-weather_messy.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_11-weather_messy.PNG"
```
...
```
## Error in knitr::include_graphics("./images/tidy/tidy_paper-table_12-weather_tidy.PNG"): Cannot find the file(s): "./images/tidy/tidy_paper-table_12-weather_tidy.PNG"
```
...
![Illustrations from the [Openscapes](https://www.openscapes.org/) blog [*Tidy Data for reproducibility, efficiency, and collaboration*](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by Julia Lowndes and Allison Horst](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/tidydata_5.jpg)

Most of your data processing phase will be spent wrangling data into a tidy format.

![Illustrations from the [Openscapes](https://www.openscapes.org/) blog [*Tidy Data for reproducibility, efficiency, and collaboration*](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by Julia Lowndes and Allison Horst](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/tidydata_6.jpg)

But once it's there, you can easily create other data products from them, including non-tidy data for presentations.

![Illustrations from the [Openscapes](https://www.openscapes.org/) blog [*Tidy Data for reproducibility, efficiency, and collaboration*](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by Julia Lowndes and Allison Horst](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/tidydata_7.jpg)
